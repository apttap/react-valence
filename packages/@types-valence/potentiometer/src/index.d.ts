...
export interface ValencePotentiometerBase<T>
...
export interface ValenceSliderProps extends ValencePotentiometerBase<number> {
  /**
...
export interface ValenceRangeSliderProps
  extends ValencePotentiometerBase<RangeValue<number>> {}
